...
int CheckSafe(int n, int m, int alloc[MAX_PROCESSES][MAX_RESOURCES], int
...
int ResourceRequest(int n, int m, int alloc[MAX_PROCESSES][MAX_RESOURCES], int
max[MAX_PROCESSES][MAX_RESOURCES], int avail[MAX_RESOURCES], int process){
